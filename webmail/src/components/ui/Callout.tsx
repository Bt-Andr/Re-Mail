...
// différent à chaque fois) dans NoSendersNotice/SelectDomainStep, et côté web dans
// ActivationCodeModal. Normalisé ici en un seul composant plutôt que trois variantes
// de padding/icône quasi identiques.
